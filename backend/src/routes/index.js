...
import draftingIssuesRoutes from './draftingIssues.routes.js';
import guidingBriefsRoutes from './guidingBriefs.routes.js';
import meetingNotesRoutes from './meetingNotes.routes.js';
import trackerActionsRoutes from './trackerActions.routes.js';
...
import hlpvV3Routes from './hlpvV3.routes.js';
...
import progressTrackerRoutes from './progressTracker.routes.js';
...
router.use('/api/admin-console/llm-settings', llmSettingsRoutes);
router.use('/api/issue-types', issueTypesRoutes);
router.use('/api/drafting-issues', draftingIssuesRoutes);
...
router.use('/api/tracker', trackerActionsRoutes);
router.use('/api/consultation', consultationRoutes);
router.use('/api/conditions', conditionsRoutes);
router.use('/api/progress-tracker', progressTrackerRoutes);
