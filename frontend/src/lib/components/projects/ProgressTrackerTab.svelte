...
<style>
  ...
  select.pt-status-inprogress { background: #fef3c7; color: #d97706; border-color: #fcd34d; }
  select.pt-status-complete   { background: #dcfce7; color: #16a34a; border-color: #86efac; }
