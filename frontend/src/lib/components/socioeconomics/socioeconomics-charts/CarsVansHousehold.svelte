<script>
  ...
  function prepareChartData() {
    ...
    console.log('=== Cars/Vans Household Chart Data ===');
    console.log('Total flattened rows:', flattenedData.length);

    // Define the car/van categories in order
    const categories = [
      'No cars or vans',
      '1 car or van',
      '2 cars or vans',
    ...
    chartInstance = new Chart(chartCanvas, {
      ...
      options: {
        ...
        plugins: {
          title: {
            display: true,
            text: 'TS045 - Car or van availability, 2021 Census',
            font: {
              size: 16,
              weight: 'bold'
            }
        ...
        scales: {
          ...
          y: {
            title: {
              display: true,
              text: 'Car/Van Ownership Category'
            }
          }
        }
      }
