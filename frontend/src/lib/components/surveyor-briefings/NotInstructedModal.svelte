<script>
  ...
  function generateDefaultContent() {
    // Default consolatory email content
    emailContent = `
      <p>Dear ${quote?.contact_name || 'Sir/Madam'},</p>
      
      <p>Thank you for providing your quote for the <strong>${quote?.discipline}</strong> survey on this project.</p>
      
      <p>After careful consideration, we regret to inform you that on this occasion we will not be proceeding with your quotation. This decision was made following a comprehensive review of all submissions and project requirements.</p>
      
      <p>We would like to thank you for the time and effort you invested in preparing your proposal. We value your professional services and hope to have the opportunity to work with <strong>${quote?.surveyor_organisation}</strong> on future projects.</p>
      
      <p>If you have any questions regarding this decision, please do not hesitate to contact us.</p>
    ...
    <div class="modal-content">
      <div class="modal-header">
        <div class="header-left">
          <i class="las la-envelope-open header-icon"></i>
