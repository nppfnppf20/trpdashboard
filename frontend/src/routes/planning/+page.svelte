...
<div class="planning-deliverables-page">
  ...
  <a href="/" class="btn btn-secondary home-button" title="Back to Home">
...
<style>
  ...
  /* Look and colour come from the shared .btn/.btn-secondary classes;
     only the corner placement is local to this page. */
  .home-button {
    position: absolute;
    top: 0.75rem;
    left: 0.75rem;
